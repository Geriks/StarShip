...
import com.example.battlecity.activities.SCORE_REQUEST_CODE
import com.example.battlecity.activities.ScoreActivity
...
class GameCore(private val activity: Activity) {
    ...
    private fun animateEndGame(score: Int) {
        activity.runOnUiThread {
            ...
            val slideUp = loadAnimation(activity, R.anim.slide_up)
