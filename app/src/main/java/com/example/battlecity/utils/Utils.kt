package com.example.battlecity.utils
...
import com.example.battlecity.activities.HORIZONTAL_MAX_SIZE
...
fun getShipByCoordinates(coordinate: Coordinate, shipsList: List<Ship>): Element? {
    return getElementByCoordinates(coordinate, shipsList.map { it.element })
}
